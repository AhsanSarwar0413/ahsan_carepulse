...
export const getAppointment = async (apppointmentId: string) => {
    try {
...
export const updateAppointment = async ({
    ...
    try {
        ...
        ${type === 'schedule'
                ...
                : `Your appointment has cancelled for the following reason: ${appointment.cancellationReason}`
            }
        `;

        await sendSMSNotification(userId, smsMessage);
        revalidatePath('/admin'); //revalidate the path. So, the changes reflected
